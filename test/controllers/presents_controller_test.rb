...
class PresentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create present" do
    assert_difference('Present.count') do
      post presents_url, params: { present: { description: @present.description, price: @present.price } }
    end
  ...
  test "should update present" do
    patch present_url(@present), params: { present: { description: @present.description, price: @present.price } }
